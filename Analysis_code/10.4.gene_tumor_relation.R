...
for(cancer in list.files()){
  ...
  pdf(paste0("/home/yanyq/share_genetics/result/WGCNA/module_cancer_relation/heatmap/", gsub("Rda","pdf",cancer)),width = 5, height = 5)
  ...
  dev.off()
  save(design, file = paste0("/home/yanyq/share_genetics/result/WGCNA/module_cancer_relation/data/", cancer))
  ...
  pdf(paste0("/home/yanyq/share_genetics/result/WGCNA/module_cancer_relation/boxplot/", gsub("Rda","pdf",cancer)), width = 6,height = 8)
  ...
  save(geneModuleMembership, file = paste0("/home/yanyq/share_genetics/result/WGCNA/module_cancer_relation/relation_data/MM/",cancer))
  ...
  save(geneTraitSignificance, file = paste0("/home/yanyq/share_genetics/result/WGCNA/module_cancer_relation/relation_data/GS/",cancer))
  ...
  for(module in selectModule){
    pdf(paste0("/home/yanyq/share_genetics/result/WGCNA/module_cancer_relation/significance/", gsub(".Rda","",cancer),"_",module,".pdf"),width=5, height=5)
